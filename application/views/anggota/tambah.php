                ...
                <form action='' method='POST'>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlInput2"
                            placeholder="MASUKKAN NAMA ANGGOTA" name="nama_anggota">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="exampleFormControlInput5"
                            aria-label="Floating label select example" name="domisili">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="exampleFormControlInput6"
                            aria-label="Floating label select example" name="angkatan">
                    ...
                    <button type="reset" class="btn btn-danger"><i class="fas fa-trash mr-1"></i>Reset</button>
                </form>
            </div>
        </div>
    </div>